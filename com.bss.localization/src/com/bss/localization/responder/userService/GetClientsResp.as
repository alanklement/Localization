package com.bss.localization.responder.userService {
	...
	public class GetClientsResp implements IResponder {
		private var _modelLocator : ModelLocator = ModelLocator.getInstance() ;

		public function GetClientsResp() {
		}
		...
		public function result($obj : Object) : void {
			...
			if ( serviceResult.result.success ) {
				_modelLocator.clients = new ArrayCollection(ArrayUtil.toArray(serviceResult.result.queryResult));
